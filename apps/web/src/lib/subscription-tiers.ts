...
export const SUBSCRIPTION_TIER_IDS = ["STARTER", "GROWTH", "PROFESSIONAL", "ENTERPRISE"] as const;
...
/**
 * Suggested prices (tiers 1–3). Enterprise is fixed at ₹25,000 as requested.
